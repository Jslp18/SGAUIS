...
function CoursesPage () {
  ...
  return (
    <div className='flex flex-col items-center my-6 w-full'>
      ...
      <div className='bg-slate-50 w-full h-[calc(100vh-22vh)] flex flex-col items-center'>
