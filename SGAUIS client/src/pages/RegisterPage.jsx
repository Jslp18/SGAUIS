    ...
    <div className='bg-white text-gray-200 shadow-md rounded-lg my-4 px-8 py-6 w-[45%]'>
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className='mb-2'>
          ...
          {errors.correo && (<p className='text-rose-400'>Por favor, completa este campo.</p>)}
        </div>
        <div className='mb-2'>
        ...
        <button type='submit' className='w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#6A8595] hover:bg-[#2B4C5D] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#273F4B]'>Crear usuario</button>
      </form>
      {
