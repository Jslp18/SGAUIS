      ...
      <div className='bg-white text-gray-200 shadow-md rounded-lg my-4 px-8 py-6 w-1/3'>
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className='mb-2'>
            ...
            {errors.nombre && (<p className='text-blue-800'>Es necesario completar el siguiente campo: Nombre completo.</p>)}
          </div>
          <div className='mb-2'>
            ...
            {errors.email && (<p className='text-blue-800'>Es necesario completar el siguiente campo: Correo electrónico.</p>)}
          </div>
          <div className='mb-2'>
