...
import {
    verCursosEstudiante, verContenidoCurso, verTareasCurso, verForosCurso, subirComentarioForo, verComentariosForo,
} from '../api/student'
...
export function StudentProvider({ children }) {
    ...
    const [homeworkSubmissionData, setHomeworkSubmission] = useState([])
    ...
    const homeworkSubmission = async (idCurso, formData) => {
        try {
            const cookies = Cookies.get()
            const config = {
                headers: {
            ...
            const response = await entregarTarea(idCurso, formData, config)
