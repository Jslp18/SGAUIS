              ...
              <div className='flex flex-row w-full space-x-10'>
                <div className='flex flex-col w-[30%] bg-white text-gray-200 shadow-2xl py-8 px-8 rounded-lg'>
                  ...
                  <form onSubmit={onForm} encType='multipart/form-data'>
                    ...
                    <div className='mb-4'>
                      <label htmlFor='pdf' className='block text-sm font-medium text-gray-700 mb-2'> {selectedFile ? (<span>Archivo seleccionado: {selectedFile.name}</span>) : (<span>o se ha seleccionado ningún archivo</span>)} </label>
