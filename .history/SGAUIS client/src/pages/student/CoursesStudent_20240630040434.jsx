                      ...
                      <div className='rounded-lg overflow-hidden shadow-gray-500 space-y-5'>
                        {commentForumData.map((comment, index5) => (
                          <div key={index5} className='relative py-2 px-4 bg-[randomizar aquí el color '>
                            ...
                            <span className='absolute bottom-4 right-2 text-sm font-normal'>{comment.usuario.nombre} - {comment.usuario.codigo}</span>
                            <span className='absolute bottom-0 right-2 text-sm font-normal'>{comment.usuario.correo}</span>
                          </div>
                        ))}
                      </div>
                    </div>
