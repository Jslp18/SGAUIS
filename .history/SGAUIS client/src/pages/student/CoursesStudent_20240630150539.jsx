...
function CoursesStudent() {
  ...
  const { studentCourses, search, errors: commentErrors, showSuccessMessage, getContentCourse, contentCourse, setContentCourse, 
    ...
    getForumsCourse, forumCourse, setForumCourse, searchForum, setSearchForum, commentForumUpload, getCommentsForum, commentForumData, setCommentForumData, searchCommentForum, setSearchCommentForum,
    homeworkSubmissionData, setHomeworkSubmissionData, setSearchHomeworkSubmission, selectedFile, setSelectedFile, homeworkSubmission, getHomeworkSubmission } = useStudent()
