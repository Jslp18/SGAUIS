              ...
              {showForumPage === 'verComentarios' && (
                <div className='flex flex-col w-full'>
                  {search === true && commentForumData.length === 0 && (
                    <div className='flex place-self-center mt-20 w-[80%]'>
                      <h1 className='font-bold text-4xl coinstracking-widest text-[#231F20] text-opacity-35 text-center'>Ups, parece que no hay ninguna respuesta a la discusión .</h1>
                    </div>
                  )}
