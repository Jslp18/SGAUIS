                      ...
                      <div className='space-y-5 mt-4'>
                        {commentForumData.map((comment, index5) => (
                          <div key={index5} className='relative p-6 rounded-lg shadow-gray-500 shadow-lg bg-white/80'>
                            ...
                            <span className='absolute bottom-5 right-4 text-sm font-normal block bg-gradient-to-tr from-sky-800 to-sky-700 bg-clip-text font-sans leading-relaxed text-transparent antialiased'>{comment.usuario.nombre} - {comment.usuario.codigo}</span>
