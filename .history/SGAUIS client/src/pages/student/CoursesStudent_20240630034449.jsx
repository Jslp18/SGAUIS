...
function CoursesStudent() {
  ...
  const { studentCourses, search, errors: commentErrors, showSuccessMessage, getContentCourse, contentCourse, setContentCourse, searchContent, setSearchContent,
    getHomeworksCourse, homeworkCourse, setHomeworkCourse, searchHomework, setSearchHomework,
    getForumsCourse, forumCourse, setForumCourse, searchForum, setSearchForum, commentForumUpload } = useStudent()
          ...
          {forumCourse.length !== 0 && (
            <div className='flex flex-col items-center justify-center w-full'>
              ...
              {showForumPage === 'verComentarios' && (
                <div>
                  Aquí se ven los comentarios del foro
                </div>
              )}
            </div>
          )}
