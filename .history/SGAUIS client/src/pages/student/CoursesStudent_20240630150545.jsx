...
function CoursesStudent() {
  ...
  const { studentCourses, search, errors: commentErrors, showSuccessMessage, getContentCourse, contentCourse, setContentCourse, 
    ...
    setCommentForumData, searchCommentForum, setSearchCommentForum, homeworkSubmissionData, setHomeworkSubmissionData, setSearchHomeworkSubmission, selectedFile, setSelectedFile, homeworkSubmission, getHomeworkSubmission } = useStudent()
  ...
  const agregarEntrega = async (homework) => {
    ...
    await getHomeworkSubmission(idHomework)
    reset()
  }
