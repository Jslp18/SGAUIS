                      ...
                      <div className='flex flex-col w-full rounded-lg bg-slate-100'>
                        <div className='rounded-lg overflow-hidden shadow-gray-500 shadow-2xl'>
                          {commentForumData.map((comment, index5) => (
                            <p key={index5} className='bg-zinc-200 border border-transparent hover:bg-zinc-300'>
                              {comment.comentario}
                            </p>
                            <span className={`absolute bottom-3 right-3 text-sm font-medium'}>{comentarioLength}<span className='text-sky-700'>/{maxCharacters}</span></span>
                          ))}
                        </div>
                      </div>
                    )}
