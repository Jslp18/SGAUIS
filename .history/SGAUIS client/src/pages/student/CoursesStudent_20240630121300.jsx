              ...
              {showHomeworkPage === 'agregarEntrega' && (
                <div className='bg-white text-gray-200 shadow-gray-400 shadow-2xl flex flex-col py-8 px-8 rounded-lg w-[50%] mt-10'>
                  ...
                  <form onSubmit={onSubmission} encType='multipart/form-data'>
                    <div className='flex flex-col my-6 bg-gray-950/15 py-6 rounded-lg items-center justify-center'>
                      <div>
                      ...
                      <label htmlFor='pdf' className='block text-sm font-medium text-gray-700 my-2'> {selectedFile ? (<span>Archivo seleccionado: {selectedFile.name}</span>) : (<span>Anexar indicaciones adicionales</span>)}</label>
