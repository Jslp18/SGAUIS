                      ...
                      <div className='flex flex-col w-full rounded-lg mt-14'>
                        <div className='rounded-lg overflow-hidden shadow-gray-500 shadow-2xl'>
                          {commentForumData.map((comment, index5) => (
                            <div key={index5} className='relative py-2 px-2'>
                              <p className='border border-transparent hover:bg-zinc-300'>{comment.comentario}</p>
                              <span className='absolute bottom-3 right-3 text-sm font-medium'>{comment.usuario.nombre}</span>
                            </div>
                          ))}
                        </div>
                      </div>
