              ...
              {showHomeworkPage === 'agregarEntrega' && (
                <div className='bg-white text-gray-200 shadow-gray-400 shadow-2xl flex flex-col py-8 px-8 rounded-lg w-[50%] mt-10'>
                  ...
                  <div className='flex flex-row items-center justify-center gap-2'>
                    <h1 className='font-bold text-xl coinstracking-widest text-neutral-700 text-center'>Agregar entrega</h1>
                    <h1 className='font-bold text-xl coinstracking-widest text-amber-700/60 text-center'>{currentHomework.titulo}</h1>
                  </div>
