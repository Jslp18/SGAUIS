...
function CoursesStudent() {
  ...
  const { studentCourses, search, errors: commentErrors, showSuccessMessage, getContentCourse, contentCourse, setContentCourse, searchContent, setSearchContent,
    ...
    homeworkSubmissionData, setHomeworkSubmissionData, searchHomeworkSubmission, setSearchHomeworkSubmission, selectedFile, setSelectedFile, homeworkSubmission } = useStudent()
            ...
            <div className='flex flex-col w-full items-center justify-center'>
              ...
              {showHomeworkPage === 'agregarEntrega' && (
                <div className='bg-white text-gray-200 shadow-gray-400 shadow-2xl flex flex-col py-8 px-8 rounded-lg w-[50%] mt-10'>
                  ...
                  {homeworkSubmissionData.estadoEntrega ? (
                    <div>Ya has realizado una entrega para {currentHomework.titulo} </div>
                  ) : (
                    <div>                    <form onSubmit={onSubmission} encType='multipart/form-data'>
