              ...
              {showHomeworkPage === 'agregarEntrega' && (
                <div className='bg-white text-gray-200 shadow-gray-400 shadow-2xl flex flex-col py-8 px-8 rounded-lg w-[50%] mt-10'>
                  ...
                  <div className='flex flex-row items-center justify-center gap-2'>
                    <h1 className='font-bold text-xl coinstracking-widest text-neutral-700 text-center'>Agregar entrega tarea </h1>
                    <h1 className='font-bold text-xl coinstracking-widest text-amber-700/60 text-center'>{currentHomework.nombre }asignada</h1>
                  </div>
                  <form onSubmit={onSubmission} encType='multipart/form-data'>
                    <div className='flex flex-col py-6 rounded-lg items-center justify-center'>
                      ...
                      <div className='bg-gray-950/10 rounded-lg space-y-4 w-full px-2 py-4'>
                        ...
                        <label htmlFor='pdf' className='block text-sm font-medium text-gray-700 mt-2'> {selectedFile ? (<span>Archivo seleccionado: {selectedFile.name}</span>) : (<span>Anexar indicaciones adicionales</span>)}</label>
