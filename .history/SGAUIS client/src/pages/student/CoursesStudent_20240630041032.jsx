                      ...
                      <div className='overflow-hidden shadow-gray-500 space-y-5'>
                        {commentForumData.map((comment, index5) => (
                          <div key={index5} className='relative py-4 px-4 rounded-lg' style={{ backgroundColor: getRandomColor() }}>
                            ...
                            <span className='absolute bottom-4 right-4 text-xs font-medium'>{comment.usuario.nombre} - {comment.usuario.codigo}</span>
                            <span className='absolute bottom-0 right-4 text-xs font-medium  '>{comment.usuario.correo}</span>
                          </div>
                        ))}
                      </div>
                    </div>
