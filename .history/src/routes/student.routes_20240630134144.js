...
// Tareas
router.post('/tareas/entregarTarea/:homeworkId', [verifyJwt.verifyToken, verifyJwt.isStudent], storage.upload.single(none), validateJson(homeworkSubmissionSchema), studentController.homeworkSubmission)
