...
// Tareas
router.post('/tareas/entregarTarea/:homeworkId', [verifyJwt.verifyToken, verifyJwt.isStudent], storage.upload.(), validateJson(homeworkSubmissionSchema), studentController.homeworkSubmission)
