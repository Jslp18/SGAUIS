...
// Tareas
router.post('/tareas/subirTarea/:courseId', [verifyJwt.verifyToken, verifyJwt.isS], storage.upload.single('pdf'), validateJson(homeworkSchema), professorController.createHomework)
