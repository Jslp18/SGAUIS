...
// Tareas
router.post('/tareas/subirTarea/:courseId', [verifyJwt.verifyToken, verifyJwt.isStudent], storage.upload.single('pdf'), validateJson(homeworkSchema), professorController.createHomework)
