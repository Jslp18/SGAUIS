...
// Tareas
router.post('/tareas/entregarTarea/:homeworkId', [verifyJwt.verifyToken, verifyJwt.isStudent], storage.upload.none(), validateJson(homeworkSubmissionSchema), studentController.homeworkSubmission)
