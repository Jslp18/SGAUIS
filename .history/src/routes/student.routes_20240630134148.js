...
// Tareas
router.post('/tareas/entregarTarea/:homeworkId', [verifyJwt.verifyToken, verifyJwt.isStudent], storage.upload.single(), validateJson(homeworkSubmissionSchema), studentController.homeworkSubmission)
