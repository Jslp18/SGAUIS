...
// Tareas
router.post('/tareas/entregarTarea/:courseId', [verifyJwt.verifyToken, verifyJwt.isStudent], storage.upload.single('pdf'), validateJson(homeworkSubmissionSchema), studentController.homeworkSubmission)
