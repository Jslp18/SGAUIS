...
export const deleteForum = async (req, res) => {
  try {
    const { forumId } = req.params; // Desde req.params se obtiene el forumId

    // Primero, eliminar todos los comentarios relacionados con el foro
    await CommentForum.deleteMany({ foro: forumId });
