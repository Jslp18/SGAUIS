...
export const homeworkSubmission = async (req, res) => {
  try {
    ...
    const newHomeworkSubmission = new HomeworkSubmission({ nombre, descripcion, calificacionMaxima, fechaEntrega, pdfFile: savedPdfFile._id, curso: courseId })

    const savedHomeworkSubmission = await newTarea.save()
